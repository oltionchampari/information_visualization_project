...
export function AppShell() {
  ...
  Split.default(
    [
      root.querySelector(".table-view") as HTMLElement,
      root.querySelector(".bottom-view") as HTMLElement,
    ],
    {
      sizes: [40, 60],
      minSize: 100,
  ...
  Split.default(
    [
      root.querySelector(".detail-view") as HTMLElement,
      root.querySelector(".detail-view-2") as HTMLElement,
    ],
    {
      sizes: [40, 60],
      minSize: 100,
