...
export class PreviewRenderer implements ICellRendererFactory {
  ...
  create(col) {
    ...
    const audio = new Audio(
      "https://p.scdn.co/mp3-preview/4e30857a3c7da3f8891483643e310bb233afadd2?cid=cfe923b2d660439caf2b557b21f31221"
    );
    return {
